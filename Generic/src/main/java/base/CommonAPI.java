...
//                System.setProperty("webdriver.chrome.driver", "/Users/jewal/IntelliJ/WebAutomationGroup3/Generic/browser-driver/chromedriver");
            ...
            if (OS.equalsIgnoreCase("OS X")) {
//                WebDriverManager.getInstance(CHROME).setup();/Users/jewal/Desktop/learning/seleniumprojectjuly2021/Generic/browser-driver/chromedriver 4

                System.setProperty("webdriver.chrome.driver", "../Generic/browser-driver/chromedriver 4");
            } else if (OS.equalsIgnoreCase("Windows")) {
                System.setProperty("webdriver.chrome.driver", "../Generic/browser-driver/chromedriver.exe");
            }
    ...
    public static void main(String[] args) {
        ...
        String name = "Jewal";
        String name2 = name.concat(" Ahmed");
        System.out.println(name + " \n   " + name2);
        String a = new String("Sharia is a good player");
        String b = "Sharia is a good player";
        if (a == b) {
            System.out.println("a == b");
        } else if (a.equals(b)) {
            System.out.println("a equals b");
        } else if (a.equalsIgnoreCase(b)) {
            System.out.println(" a.euqalIgnoreCase(b) ");
        }


        String s1 = "Sharia is a good player";
        String s2 = new String("Sharia is a good player");
        s2 = s2.intern();
        System.out.println(s1 == s2);
        boolean tr = Pattern.matches("...s.", "mktst");
